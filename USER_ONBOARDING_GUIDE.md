...
## Post-Onboarding: 30-Day Success Plan

### Week 1: Foundation
- [ ] Complete account setup
- [ ] Connect primary data sources (admin)
- [ ] Invite core team members (admin)
- [ ] Send 10+ messages to AI
- [ ] Try both private and team modes

### Week 2: Exploration
- [ ] Generate first visualization
- [ ] Set up first scheduled report
- [ ] Participate in team conversation
- [ ] Save a useful visualization
- [ ] Explore help center
...
2. ✅ Sends at least 5 messages to AI within first week
3. ✅ Connects at least one data source (admins only)
4. ✅ Returns for 3+ sessions in first week
5. ✅ Generates at least one visualization or scheduled report

**Ultimate Success**: User becomes a weekly active user (WAU) with regular engagement patterns.
