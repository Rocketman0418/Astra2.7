...
const STEPS: StepContent[] = [
  ...
  {
    title: 'Meeting Notes',
    astraMessage: "Now let's connect your Meeting Notes. These documents capture decisions, action items, and team discussions. With meeting notes synced, I can help you track decisions, summarize key takeaways, and identify patterns across your team conversations.",
    examples: [
      "Team meeting notes",
