...
export const MarketingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-8">
      <div className="max-w-[1200px] w-full space-y-10 py-8">
        ...
        {/* Features Grid - 8 boxes in 2 rows of 4 - 25% bigger */}
        <div className="grid grid-cols-4 gap-8 mb-10">
            {/* 1. All Your Data Connected */}
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-orange-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-orange-500/10 flex items-center justify-center mb-5">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-purple-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-purple-500/10 flex items-center justify-center mb-5">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-blue-500/10 flex items-center justify-center mb-5">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-emerald-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-emerald-500/10 flex items-center justify-center mb-5">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-yellow-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-yellow-500/10 flex items-center justify-center mb-5">
            ...
            {/* 6. Agent Builder */}
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-pink-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-pink-500/10 flex items-center justify-center mb-5">
            ...
            {/* 7. Email Control */}
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-indigo-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-indigo-500/10 flex items-center justify-center mb-5">
            ...
            {/* 8. AI Job Roles */}
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-teal-500/50 transition-all duration-300">
              <div className="w-16 h-16 rounded-lg bg-teal-500/10 flex items-center justify-center mb-5">
