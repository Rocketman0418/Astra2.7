        ...
        <div className="space-y-3">
          <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-white text-sm font-semibold">What are Strategy Documents?</h4>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-blue-950/50 rounded-lg p-2 flex items-center gap-2">
                ...
                <span className="text-xs text-blue-200">Mission & Vision</span>
              </div>
              <div className="bg-blue-950/50 rounded-lg p-2 flex items-center gap-2">
                <span className="text-base">⭐</span>
                <span className="text-xs text-blue-200">Core Values</span>
              </div>
              <div className="bg-blue-950/50 rounded-lg p-2 flex items-center gap-2">
                <span className="text-base">🎯</span>
                <span className="text-xs text-blue-200">Goals & OKRs</span>
              </div>
              <div className="bg-blue-950/50 rounded-lg p-2 flex items-center gap-2">
                <span className="text-base">🗺️</span>
                <span className="text-xs text-blue-200">Strategic Plans</span>
              </div>
            </div>
          </div>
