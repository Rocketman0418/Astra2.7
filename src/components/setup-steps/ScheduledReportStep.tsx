...
export const ScheduledReportStep: React.FC<ScheduledReportStepProps> = ({ onComplete, onSkip }) => {
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-3">ScheduledReportStep</h2>
