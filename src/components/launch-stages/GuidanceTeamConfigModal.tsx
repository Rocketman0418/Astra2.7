      ...
      <div className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden border border-gray-700">
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          {isLoading ? (
            ...
            <>
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-white mb-2">Meeting Types</h3>
                <p className="text-gray-400 text-sm mb-4">
                  Configure which types of meetings your team has. This helps Astra better understand
                  and categorize your meeting recordings.
                </p>
              </div>
